...
"Micro-Todo" is a website that managed the list of todo.
...
after cloning Repository [HERE]([url](https://github.com/freddykaberuka/micro-todo.git) open the folder and run npm install to install all the modules in your local storage
